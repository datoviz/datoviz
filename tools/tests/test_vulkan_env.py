...
class VulkanEnvironmentTest(unittest.TestCase):
    """Validate default and sanitized macOS environment selection."""
    ...
    def test_sanitized_mode_selects_only_the_active_sdk(self) -> None:
        """Sanitized mode removes stale selectors and direct library paths."""
