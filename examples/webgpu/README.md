...
modules. The 2D proof renders point, pixel, marker, segment, primitive, image, and mesh visuals
with panzoom.
...
The 3D WASM proof uses the same generic ABI wrapper with a textured mesh, scene-owned camera, and
arcball controller:
