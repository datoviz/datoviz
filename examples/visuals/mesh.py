...
sc.add_tetrahedron(offset=(-1, 0.5, -.5), scale=scale, color=colors[0])
sc.add_hexahedron(offset=(0, 0.5, -.5), scale=scale, color=colors[1])
sc.add_octahedron(offset=(1, 0.5, -.5), scale=scale, color=colors[2])
