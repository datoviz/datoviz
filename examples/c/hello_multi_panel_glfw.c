...
/* hello_multi_panel_glfw — live multi-panel scene smoke example.
 *
 ...
 *
 * Build:  just example-c hello_multi_panel_glfw
 * Run:    ./build/examples/c/hello_multi_panel_glfw
 * Smoke:  ./build/examples/c/hello_multi_panel_glfw 300
 */
...
int main(int argc, char** argv)
{
    ...
    DvzAppWindow* win = dvz_app_window_glfw(app, figure, WIDTH, HEIGHT, "hello_multi_panel_glfw");
    if (win == NULL)
    {
