...
static void _state_apply_spin(TexturedMeshState* state)
{
    ...
    dvz_anim_set_speed(state->spin.animation, speed);
}
...
int main(int argc, char** argv)
{
    ...
    dvz_panel_set_background_color(panel, dvz_color_from_unit(0.025f, 0.028f, 0.034f, 1.0f));

    app = dvz_app(scene);
    EXAMPLE_CHECK(app != NULL, "dvz_app() failed (no GPU or display?)");

    DvzView* win = dvz_view_window(app, figure, WIDTH, HEIGHT, "textured mesh");
    ...
    dvz_anim_set_speed(gui_state.spin.animation, gui_state.spin_speed);
    dvz_anim_start(gui_state.spin.animation, 0.0);
