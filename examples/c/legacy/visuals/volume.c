...
/* volume - synthetic retained volume visual via scene/app/GLFW.
 *
 * Build:  just example-c visuals/volume
 * Run:    ./build/examples/c/visuals/volume
 * Smoke:  ./build/examples/c/visuals/volume 60
 */
...
int main(int argc, char** argv)
{
    ...
    spin.animation = dvz_anim_visual_transform(scene, volume, &transform_desc);
