...
#define EXAMPLE_WINDOW_WIDTH  1280u
#define EXAMPLE_WINDOW_HEIGHT 720u
#define EXAMPLE_OUTPUT_WIDTH  1920u
#define EXAMPLE_OUTPUT_HEIGHT 1080u
...
typedef enum ExampleStyleTextRole
{
    ...
    EXAMPLE_STYLE_TEXT_LEGEND_LABEL,
