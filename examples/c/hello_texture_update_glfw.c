...
/* hello_texture_update_glfw — live sampled-field partial-update smoke example.
 *
 ...
 * path.
 *
 * Build:  just example-c hello_texture_update_glfw
 * Run:    ./build/examples/c/hello_texture_update_glfw
 * Smoke:  ./build/examples/c/hello_texture_update_glfw 300
 */
...
int main(int argc, char** argv)
{
    ...
    DvzAppWindow* win =
        dvz_app_window_glfw(app, figure, WIDTH, HEIGHT, "hello_texture_update_glfw");
    if (win == NULL)
    {
