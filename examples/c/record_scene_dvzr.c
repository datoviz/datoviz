...
/* record_scene_dvzr — capture an offscreen app scene and replay its DVZR recording.
 *
 * Build:  just build
 * Run:    ./build/examples/c/record_scene_dvzr
 *
 * Outputs next to the executable:
 *   record_scene_dvzr.dvzr/
 *   record_scene_dvzr_original.png
 *   record_scene_dvzr_replay.png
 */
...
int main(int argc, char** argv)
{
    ...
    _outpath(argv[0], "record_scene_dvzr.dvzr", recording_path, sizeof(recording_path));
    _outpath(argv[0], "record_scene_dvzr_original.png", original_png, sizeof(original_png));
    _outpath(argv[0], "record_scene_dvzr_replay.png", replay_png, sizeof(replay_png));
    ...
    dvz_fprintf(stdout, "record_scene_dvzr: wrote %s\n", recording_path);
    dvz_fprintf(stdout, "record_scene_dvzr: wrote %s\n", original_png);
    dvz_fprintf(stdout, "record_scene_dvzr: wrote %s\n", replay_png);
    return 0;
}
