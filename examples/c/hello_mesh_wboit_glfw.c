 ...
 * A GUI overlay exposes live shell color, alpha, ambient/diffuse, and light-direction sliders. The
 * visual alpha-mode opt-in exercises scene planning, DRP2 WBOIT accumulation/resolve, and the
