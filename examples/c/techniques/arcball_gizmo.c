...
int main(int argc, char** argv)
{
    ...
    DvzController* shared_controller = dvz_panel_controller(main_panel, DVZ_DIM_X);
    EXAMPLE_CHECK(shared_controller != NULL, "failed to retrieve main arcball controller");
    rc = dvz_panel_bind_controller(gizmo_panel, shared_controller, DVZ_DIM_MASK_XYZ);
