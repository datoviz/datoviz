...
/* hello_mesh_depth_peel_glfw — transparent mesh via scene depth peeling + app/GLFW.
 *
 ...
 *
 * Build:  just example-c hello_mesh_depth_peel_glfw
 * Run:    ./build/examples/c/hello_mesh_depth_peel_glfw
 * Smoke:  ./build/examples/c/hello_mesh_depth_peel_glfw 60
 */
