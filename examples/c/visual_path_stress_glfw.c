...
/* visual_path_stress_glfw - live GLFW stress tool for retained path visuals.
 *
 * Build:  just example-c visual_path_stress_glfw
 * Run:    ./build/examples/c/visual_path_stress_glfw
 * Smoke:  ./build/examples/c/visual_path_stress_glfw 300
 */
...
int main(int argc, char** argv)
{
    ...
    DvzAppWindow* win =
        dvz_app_window_glfw(app, figure, WIDTH, HEIGHT, "visual_path_stress_glfw");
    if (win == NULL)
    {
