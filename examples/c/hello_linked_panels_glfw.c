...
/* hello_linked_panels_glfw — live linked-panel panzoom smoke example.
 *
 ...
 *
 * Build:  just example-c hello_linked_panels_glfw
 * Run:    ./build/examples/c/hello_linked_panels_glfw
 * Smoke:  ./build/examples/c/hello_linked_panels_glfw 300
 */
...
int main(int argc, char** argv)
{
    ...
    DvzAppWindow* win =
        dvz_app_window_glfw(app, figure, WIDTH, HEIGHT, "hello_linked_panels_glfw");
    if (win == NULL)
    {
