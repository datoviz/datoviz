...
/* hello_image_probe_glfw — live image-probe smoke example.
 *
 ...
 *
 * Build:  just example-c hello_image_probe_glfw
 * Run:    ./build/examples/c/hello_image_probe_glfw
 * Smoke:  ./build/examples/c/hello_image_probe_glfw 300
 */
...
int main(int argc, char** argv)
{
    ...
    DvzAppWindow* win = dvz_app_window_glfw(app, figure, WIDTH, HEIGHT, "hello_image_probe_glfw");
    if (win == NULL)
    {
