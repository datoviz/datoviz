...
cdef extern from "<datoviz/datoviz.h>":
    ...
    ctypedef enum DvzPropType:
        ...
        DVZ_PROP_ANCHOR = 10
        DVZ_PROP_LINE_WIDTH = 11
        DVZ_PROP_MITER_LIMIT = 12
        DVZ_PROP_CAP_TYPE = 13
        DVZ_PROP_JOIN_TYPE = 14
        DVZ_PROP_TOPOLOGY = 15
        DVZ_PROP_LENGTH = 16
        DVZ_PROP_RANGE = 17
        DVZ_PROP_MARGIN = 18
        DVZ_PROP_NORMAL = 19
        DVZ_PROP_TEXCOORDS = 20
        DVZ_PROP_TEXCOEFS = 21
        DVZ_PROP_TRANSFER_X = 22
        DVZ_PROP_TRANSFER_Y = 23
        DVZ_PROP_LIGHT_POS = 24
        DVZ_PROP_LIGHT_PARAMS = 25
        DVZ_PROP_CLIP = 26
        DVZ_PROP_MODEL = 27
        DVZ_PROP_VIEW = 28
        DVZ_PROP_PROJ = 29
        DVZ_PROP_VIEWPORT = 30
        DVZ_PROP_TIME = 31
        DVZ_PROP_INDEX = 32
        DVZ_PROP_SCALE = 33
        DVZ_PROP_TRANSFORM = 34
