cdef extern from "<datoviz/common.h>":
    ...
    ctypedef enum DvzClientEventType:
        ...
        DVZ_CLIENT_EVENT_INIT = 1
        DVZ_CLIENT_EVENT_WINDOW_CREATE = 2
        DVZ_CLIENT_EVENT_WINDOW_RESIZE = 3
        DVZ_CLIENT_EVENT_WINDOW_DELETE = 4
        DVZ_CLIENT_EVENT_FRAME = 5
        DVZ_CLIENT_EVENT_MOUSE = 6
        DVZ_CLIENT_EVENT_KEYBOARD = 7
        DVZ_CLIENT_EVENT_TIMER = 8
        DVZ_CLIENT_EVENT_REQUESTS = 9
        DVZ_CLIENT_EVENT_DESTROY = 10
