...
// some compile-time options have an affect on data structures. Defining those options in
// imconfig.h will ensure every compilation unit gets to see the same data structure layouts. Call
// IMGUI_CHECKVERSION() from your .cpp files to verify that the data structures your files are
...
//---- Define constructor and implicit cast operators to convert back<>forth between your math
...
//---- Use 32-bit vertex indices (default is 16-bit) is one way to allow large meshes with more
//than 64K vertices.
