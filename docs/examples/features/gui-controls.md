...
<span class="dvz-example-nav__previous"><a href="../update-visual-data/">← Previous: Visual Data Update</a></span>
<span class="dvz-example-nav__next"><a href="../gui-viewport/">Next: GUI Viewport →</a></span>
</div>
</nav>
