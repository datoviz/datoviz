...
<span class="dvz-example-nav__previous"><a href="../user-scale/">← Previous: User Scale</a></span>
<span class="dvz-example-nav__next"><a href="../visual-transform/">Next: Visual Transform →</a></span>
</div>
</nav>
