...
<span class="dvz-example-nav__previous"><a href="../visual-transform/">← Previous: Visual Transform</a></span>
<span class="dvz-example-nav__next"><a href="../camera-manual/">Next: Manual Camera →</a></span>
</div>
</nav>
...
| --- | --- | --- |
| C | Canonical native source | `just example-c features/visibility` (build and run), or rerun `./build/examples/c/features/visibility` |
| Python | Available; direct-engine adaptation | `python3 -m examples.python.gallery.features.visibility` |
| Browser | Live WebGPU route | <a href="../../webgpu/live.html?id=features_visibility">Open live example</a> |
