...
<span class="dvz-example-nav__previous"><a href="../text-block/">← Previous: Text Block</a></span>
<span class="dvz-example-nav__next"><a href="../probe-labels/">Next: Label Probe →</a></span>
</div>
</nav>
...
| --- | --- | --- |
| C | Canonical native source | `just example-c features/overlay_card` (build and run), or rerun `./build/examples/c/features/overlay_card` |
| Python | Available; direct-engine adaptation | `python3 -m examples.python.gallery.features.overlay_card` |
| Browser | Live WebGPU route | <a href="../../webgpu/live.html?id=features_overlay_card">Open live example</a> |
