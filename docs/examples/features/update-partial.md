...
<span class="dvz-example-nav__previous"><a href="../compute-buffer-animation/">← Previous: Compute Buffer Animation</a></span>
<span class="dvz-example-nav__next"><a href="../update-visual-data/">Next: Visual Data Update →</a></span>
</div>
</nav>
