...
<span class="dvz-example-nav__previous"><a href="../gui-data-widgets/">← Previous: Retained GUI Data Widgets</a></span>
<span class="dvz-example-nav__next"><a href="../json-export/">Next: JSON Export →</a></span>
</div>
</nav>
