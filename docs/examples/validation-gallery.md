...
| [Polygon Composite](gallery/features/composite_polygon.md) | [`examples/c/features/polygon.c`](https://github.com/datoviz/datoviz/blob/v0.4-dev/examples/c/features/polygon.c) | `supported` | `smoke+screenshot` |
| [Graph Composite](gallery/features/composite_graph.md) | [`examples/c/features/graph.c`](https://github.com/datoviz/datoviz/blob/v0.4-dev/examples/c/features/graph.c) | `supported` | `smoke+screenshot` |
