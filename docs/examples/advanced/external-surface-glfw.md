...
<span class="dvz-example-nav__previous"><a href="../cuda-external-buffer/">← Previous: CUDA External Buffer</a></span>
<span class="dvz-example-nav__next"><a href="../gui-implot/">Next: Datoviz with ImPlot →</a></span>
</div>
</nav>
