...
- WebGPU live route: [`examples/webgpu/live.html?id=feature_builtin_shapes_2d`](/examples/webgpu/live.html?id=feature_builtin_shapes_2d)
...
<iframe src="/examples/webgpu/live.html?id=feature_builtin_shapes_2d" title="Builtin Shapes 2D WebGPU live example" loading="lazy" allow="fullscreen; webgpu"></iframe>
</div>

[Open the live WebGPU example](/examples/webgpu/live.html?id=feature_builtin_shapes_2d).
