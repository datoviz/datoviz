...
=== "Live WebGPU"
    ...
    <iframe src="../../../webgpu/live.html?id=showcases_textured_planet" title="Textured Planets WebGPU live example" loading="lazy" allow="fullscreen; webgpu"></iframe>
    </div>
...
<a href="../showcases_surface_grid">Previous: Surface Grid</a>
</div>
</nav>
