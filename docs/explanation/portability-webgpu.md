...
basic/textured mesh, basic sphere, panzoom, and a 3D sphere + textured mesh scene with arcball
...
| Visual families | broader retained v0.4 visual surface | point, pixel, basic marker, basic segment, primitive, RGBA8 image, basic/textured mesh, and basic sphere demos |
