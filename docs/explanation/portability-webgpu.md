...
The first scene subset proves point, pixel, marker, segment/path cap-join controls, primitive,
RGBA8 image, basic/textured/material mesh, basic sphere, panzoom, and a 3D sphere + textured mesh scene with arcball
...
| Visual families | broader retained v0.4 visual surface | point, pixel, basic marker, segment/path cap-join controls, primitive, RGBA8 image, basic/textured/material mesh, and basic sphere demos |
