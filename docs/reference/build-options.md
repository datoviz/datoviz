...
| `DVZ_BUILD_IMPLOT_EXAMPLE` | `OFF` | Fetch pinned ImPlot v1.0 sources and build the optional Datoviz/ImPlot integration example. Set `DVZ_IMPLOT_SOURCE_DIR` to use a local ImPlot checkout instead. |
