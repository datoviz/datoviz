...
| `DVZ_BUILD_IMPLOT_EXAMPLE` | `ON` | Fetch pinned ImPlot v1.0 sources and build the Datoviz/ImPlot integration example. Set this option to `OFF` to skip the dependency, or set `DVZ_IMPLOT_SOURCE_DIR` to use a local ImPlot checkout. |
