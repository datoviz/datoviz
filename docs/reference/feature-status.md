...
| Python direct-engine facade | supported | [Python direct-engine facade](python-direct-engine.md) | Top-level `import datoviz as dvz` keeps C-shaped `dvz_*` names while adapting declared NumPy array uploads and RGBA capture helpers. |
