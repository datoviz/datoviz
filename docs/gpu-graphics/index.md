...
!!! note "RC3 availability"
    Chapters 1 to 3 are available in RC3. Chapters 4 to 15 and the closing chapter are planned for RC4; the summaries below describe lessons that are not published yet.
...
**Part 2: Triangles, shaders, pipeline, and vertex data (RC4 roadmap)**
