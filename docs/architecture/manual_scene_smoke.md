...
Expected behavior: trace/status output is visible, unchanged repeated frames stay compact, and the
live example still renders and exits after the bounded frame count.
