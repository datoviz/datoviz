...
`examples/c/MANIFEST.yaml` and the canonical example source comments. They are committed so reviews
and release branches contain the exact documentation that will be published.
