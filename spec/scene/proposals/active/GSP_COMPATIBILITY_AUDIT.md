...
| Unified panel query API | `DvzQueryRequest`, `DvzQueryResult`, `dvz_panel_query_px()`, `dvz_scene_poll_query()`, `dvz_figure_process_queries()`, `dvz_panel_query_now_px()` | `include/datoviz/scene/interaction.h`, `include/datoviz/scene/types.h`, `src/scene/query/` | Public pick/probe split is gone. |
