...
4. [DPI_SCALE_IMPLEMENTATION_PLAN.md](DPI_SCALE_IMPLEMENTATION_PLAN.md): implementation roadmap for high-DPI consistency and dynamic user scale.
5. [HIDPI_LIVE_WINDOW_IMPLEMENTATION.md](HIDPI_LIVE_WINDOW_IMPLEMENTATION.md): live GLFW high-DPI sizing, input normalization, and text-anchor implementation plan.
6. [OPTIONAL_PROVIDERS.md](OPTIONAL_PROVIDERS.md): optional dependency, bridge, recipe, custom visual, and technique extension boundaries.
