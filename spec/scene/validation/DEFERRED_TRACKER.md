...
| Full Gaussian-splat pipeline beyond the possible v0.4 experimental retained splat visual: trained asset formats, differentiable rendering, out-of-core splat scenes, advanced splat LOD, and production splat asset tooling | `spec/scene/examples/EXAMPLE_RELEASE_STAGING.md`, `spec/scene/examples/EXAMPLE_GAP_REPORT.md` |
