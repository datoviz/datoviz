...
The scene API never takes a `DvzCanvas*` argument directly. See `RUNTIME_BOUNDARY.md` for the
...
5. inline colormap and scale shortcuts (see `SCALES.md`),
...
The inline scale shortcut in `SCALES.md` maps to a sugar-layer convenience; it does not require
