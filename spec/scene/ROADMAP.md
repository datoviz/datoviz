...
| --- | --- | --- |
| Point, pixel, marker, symbols | [visuals/POINT.md](visuals/POINT.md), [visuals/PIXEL.md](visuals/PIXEL.md), [visuals/MARKER.md](visuals/MARKER.md), [semantics/SYMBOLS.md](semantics/SYMBOLS.md) | Native target/crosshair marker, reusable `DvzSymbolSet`, built-in/bitmap/SDF/MSDF/SVG symbol sources, exact SDF marker picking, shared symbol/glyph atlas substrate, remaining scalar/grouped/constant attributes, `shift`, data-space sizes, backend-aware point-like lowering. |
