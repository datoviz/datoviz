...
SDF, and MSDF source APIs copy payloads into scene-owned symbol records; atlas-backed marker
rendering and SVG path import remain active v0.4 parity work. Marker `shape` remains the
compatibility path for built-in code-SDF symbols.
