...
SDF, MSDF, and SVG path sources are active v0.4 parity work for later symbol-resource slices. Marker
`shape` remains the compatibility path for built-in code-SDF symbols.
