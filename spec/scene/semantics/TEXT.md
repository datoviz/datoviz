...
[../proposals/promoted/TEXT_DESIGN.md](../proposals/promoted/TEXT_DESIGN.md) remains the rationale and staging note
...
text state; glyph visuals are derived rendering output or low-level escape hatches.
