...
`feature_builtin_shapes_2d`, `feature_builtin_shapes_3d`, `sphere_impostor`, `volume`,
`composite_polygon`, `composite_graph`, `protein_arcball_viewer`, `showcase_wind_field`,
