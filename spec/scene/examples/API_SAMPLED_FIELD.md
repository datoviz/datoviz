...
dvz_visual_set_field(image_scalar, "texture", field_scalar_2d);
...
dvz_visual_set_field(image_rgba, "texture", field_rgba_2d);
...
dvz_visual_set_field(volume, "texture", field_scalar_3d);
