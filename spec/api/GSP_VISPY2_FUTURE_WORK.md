...
| Mesh-face query | Public `DVZ_SCENE_TARGET_FACE`, face identity, primitive identity, capability flags, bindings, and focused native tests already exist. | No Datoviz implementation is currently required; GSP adapter work owns the next step. |
