...
Status: implemented v0.4 architecture and release contract. Official-package and supported-platform proof remain RC3 gates; RC4 owns exact-artifact course proof and freeze. Updated: 2026-09-17.
