...
logs, Vulkan validation output, sanitizer output, crashes, or Python tracebacks are blocking for
machine validation even when the command exits with status 0. Warning diagnostics are recorded under
machine evidence `warnings` for maintainer review.
