...
| `feature.scalebar` | `examples/c/features/scalebar.c`, `examples/c/workflows/scalebar_measurement.c`, `examples/c/lab/scalebar_2d_3d.c` | Candidate public feature proof is intentionally minimal; richer overview/detail/3D measurement composition lives in the workflow lane, and the 2D/3D comparison stays in lab. |
