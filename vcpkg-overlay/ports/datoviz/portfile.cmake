...
if(DATOVIZ_MSDF_RUNTIME_LIBS)
    file(INSTALL ${DATOVIZ_MSDF_RUNTIME_LIBS} DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
endif()
if(DATOVIZ_MSDF_DEBUG_RUNTIME_LIBS)
    file(INSTALL ${DATOVIZ_MSDF_DEBUG_RUNTIME_LIBS} DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
endif()
