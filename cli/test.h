...
static int visuals_props_1(VkyCanvas* canvas)
{
...
static int visuals_props_2(VkyCanvas* canvas)
{
    VkyVisual v = _blank_visual();
...
static int visuals_props_3(VkyCanvas* canvas)
{
    VkyVisual v = _blank_visual();
...
static int visuals_props_4(VkyCanvas* canvas)
{
    VkyVisual v = _blank_visual();
    vky_visual_prop_spec(&v, 3, 0);
    vky_visual_prop_add(&v, VKY_VISUAL_PROP_POS_GPU, 0); // 1 byte
...
static int visuals_props_5(VkyCanvas* canvas)
{
    VkyVisual v = _blank_visual();
...
static int visuals_props_6(VkyCanvas* canvas)
{
...
static int transform_1(VkyCanvas* canvas)
{
...
static int transform_2(VkyCanvas* canvas)
{
    vky_reset_grid(canvas->scene, 2, 4);
    VkyPanel* panel = vky_get_panel(canvas->scene, 1, 2);
...
static int panzoom_1(VkyCanvas* canvas)
{
...
static int test_vklite_compute(VkyCanvas* canvas)
{
