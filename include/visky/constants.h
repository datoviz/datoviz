...
#define VKY_MAX_VISUAL_PROP_COUNT        VKY_CONST_INT(VKY_MAX_VISUAL_COUNT_ID, 100)
#define VKY_MAX_VISUAL_RESOURCES         VKY_CONST_INT(VKY_MAX_VISUAL_RESOURCES_ID, 100)
#define VKY_MAX_VISUALS_CHILDREN         VKY_CONST_INT(VKY_MAX_VISUAL_COUNT_ID, 100)
...
#define VKY_AXES_MARGIN_LEFT          VKY_CONST(VKY_AXES_MARGIN_LEFT_ID, 120.0)
