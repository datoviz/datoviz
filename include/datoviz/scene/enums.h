...
typedef enum
{
    DVZ_PICK_STATUS_UNKNOWN = 0,
    DVZ_PICK_STATUS_HIT,
    DVZ_PICK_STATUS_MISS,
    DVZ_PICK_STATUS_OUTSIDE_PANEL,
    DVZ_PICK_STATUS_UNSUPPORTED_TARGET,
    DVZ_PICK_STATUS_NO_CAPABLE_VISUAL,
    DVZ_PICK_STATUS_GPU_EXEC_FAILED,
    DVZ_PICK_STATUS_READBACK_FAILED,
    DVZ_PICK_STATUS_STALE_DROPPED,
    DVZ_PICK_STATUS_INVALID_RESULT,
} DvzPickStatus;
