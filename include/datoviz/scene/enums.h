...
typedef enum
{
    DVZ_PROBE_STATUS_UNKNOWN = 0,
    DVZ_PROBE_STATUS_HIT,
    DVZ_PROBE_STATUS_MISS,
    DVZ_PROBE_STATUS_OUTSIDE_PANEL,
    DVZ_PROBE_STATUS_UNSUPPORTED_TARGET,
    DVZ_PROBE_STATUS_NO_CAPABLE_VISUAL,
    DVZ_PROBE_STATUS_GPU_EXEC_FAILED,
    DVZ_PROBE_STATUS_READBACK_FAILED,
    DVZ_PROBE_STATUS_STALE_DROPPED,
    DVZ_PROBE_STATUS_INVALID_RESULT,
} DvzProbeStatus;
...
typedef enum
{
    ...
    DVZ_QUERY_PROFILE_PACKED_RGBA8,
} DvzQueryProfile;
