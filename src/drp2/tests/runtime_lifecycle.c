...
int test_drp2_runtime_frame_target_validation(TstContext* suite, const TstCase* item)
{
    ...
    frame.usage |= DVZ_STREAM_FRAME_USAGE_COPY_SRC;
    ...
    AT((frame_target->usage & DVZ_DRP2_TEXTURE_USAGE_COPY_SRC) != 0);
    AT((frame_target->usage & DVZ_DRP2_TEXTURE_USAGE_COPY_DST) != 0);
