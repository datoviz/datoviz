...
int test_scene_graph(TstSuite* suite)
{
    ...
    TST_CASE(test_scene_role_policy_mapping_complete);
    ...
    TST_CASE(test_scene_msaa_gtao_blended_overlay_runtime_lowering);
    ...
    TST_CASE(test_scene_gtao_graph_foundation);
    TST_CASE(test_scene_gtao_runtime_lowering);
    TST_SCENE_GRAPH_GPU_CASE(test_scene_gtao_glsl_executes);
    TST_SCENE_GRAPH_GPU_CASE(test_scene_sphere_gtao_glsl_executes);
    TST_CASE(test_scene_gtao_ignores_ineligible_visuals);
    ...
    TST_CASE(test_scene_visual_alpha_mode_noncontiguous_wboit_preserves_order);
    TST_CASE(test_scene_visual_alpha_mode_noncontiguous_depth_peel_preserves_order);
