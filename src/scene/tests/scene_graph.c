...
int test_scene_graph(TstSuite* suite)
{
    ...
    TST_CASE(test_scene_visual_attach_explicit_rects_emit_metadata);
    ...
    TST_CASE(test_scene_panel_frame_snapshot_guide_layouts);
    TST_CASE(test_scene_panel_view3d_state_readback);
    ...
    TST_CASE(test_scene_msaa_mixed_plain_panel_resolve_region);
    ...
    TST_CASE(test_scene_msaa_runtime_capability_disable_topology);
    ...
    TST_CASE(test_scene_visual_public_introspection);
    TST_CASE(test_scene_public_validation);
