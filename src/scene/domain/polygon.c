 ...
 */
DvzResult dvz_polygon_set_geometry(DvzPolygon* polygon, const DvzPolygonDesc* desc)
{
 ...
 */
DvzResult dvz_polygon_set_id(DvzPolygon* polygon, uint64_t id)
{
    if (polygon == NULL || polygon->scene == NULL)
        return -1;
 ...
 * @return 0 on success, -1 on error
 */
DvzResult dvz_polygon_set_visible(DvzPolygon* polygon, bool visible)
{
    if (polygon == NULL || polygon->scene == NULL)
        return -1;
 ...
 * @return 0 on success, -1 on error
 */
DvzResult dvz_polygon_set_fill_color(DvzPolygon* polygon, const DvzColor color)
{
    if (polygon == NULL || polygon->scene == NULL)
        return -1;
 ...
 * @return 0 on success, -1 on error
 */
DvzResult dvz_polygon_set_stroke_color(DvzPolygon* polygon, const DvzColor color)
{
    if (polygon == NULL || polygon->scene == NULL)
        return -1;
 ...
 */
DvzResult dvz_polygon_set_stroke_width_px(DvzPolygon* polygon, float width)
{
 ...
 * @return 0 on success, -1 on error
 */
DvzResult dvz_polygon_set_stroke_caps(DvzPolygon* polygon, DvzSegmentCap start_cap, DvzSegmentCap end_cap)
{
    if (
 ...
 * @return 0 on success, -1 on error
 */
DvzResult dvz_polygon_set_stroke_join(DvzPolygon* polygon, DvzPathJoin join, float miter_limit)
{
    if (
