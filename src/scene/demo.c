...
DvzVisual* dvz_demo_panel_2D(DvzPanel* panel)
{
    ANN(panel);

    uint32_t n = 1000;
    vec3* pos = dvz_mock_pos_2D(n, .25);
...
DvzVisual* dvz_demo_panel_3D(DvzPanel* panel)
{
    ANN(panel);
...
void dvz_demo(void)
{
    ...
    DvzVisual* image = dvz_image(batch, 0);
    {
        ...
        dvz_image_texture(image, texture);

        FREE(imgdata);
    }

    legend(batch, p23, "IMAGE", &af);
    dvz_panel_panzoom(p23, 0);
    ...
    dvz_arcball_initial(dvz_panel_arcball(p30, 0), (vec3){+0.4, -0.8, +2.9});
    dvz_camera_initial(
    ...
    dvz_arcball_initial(dvz_panel_arcball(p31, 0), (vec3){+0.4, -0.8, +2.9});
    dvz_camera_initial(
    ...
    dvz_arcball_initial(dvz_panel_arcball(p32, 0), (vec3){+0.4, -0.8, +2.9});
    dvz_camera_initial(
    ...
    DvzVisual* slice = dvz_slice(batch, DVZ_VOLUME_FLAGS_RGBA);
    {
        ...
        dvz_slice_texture(slice, texture);
    ...
    dvz_arcball_initial(dvz_panel_arcball(p33, 0), (vec3){+0.4, -0.8, +2.9});
    dvz_camera_initial(
