 ...
 */
bool _scene_splat_visual_lowering(const DvzVisual* visual, DvzVisualLowering* out)
{
    ANN(visual);
    ANN(out);
...
/**
 * Resolve splat visual bind-group role metadata.
 *
 ...
 */
bool _scene_splat_visual_bind_desc(
