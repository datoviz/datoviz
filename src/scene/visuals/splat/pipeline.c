...
/*************************************************************************************************/
/*  Splat visual pipeline descriptors                                                            */
/*************************************************************************************************/
...
/**
 * Resolve splat visual pipeline metadata.
 *
 ...
 */
bool _scene_splat_visual_pipeline_desc(
    ...
    DvzSceneShaderFormat shader_format, DvzSceneVisualPipelineDesc* out)
{
    ...
    _scene_visual_pipeline_attr(out, 2, 2, 2, DVZ_FORMAT_R32G32_SFLOAT, 2 * sizeof(float));
