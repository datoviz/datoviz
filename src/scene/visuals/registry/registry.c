...
static const DvzVisualFamilyOps VISUAL_FAMILY_OPS[] = {
    {DVZ_VISUAL_TYPE_POINT, "point", _scene_point_visual_lowering, _scene_visual_default_bounds,
     _scene_visual_default_pass_caps, _scene_point_visual_bind_desc,
     _scene_point_visual_pipeline_desc, _scene_point_visual_shader_desc,
     _scene_point_visual_draw_desc, NULL, false, true},
    {DVZ_VISUAL_TYPE_PIXEL, "pixel", _scene_pixel_visual_lowering, _scene_visual_default_bounds,
     _scene_visual_default_pass_caps, _scene_pixel_visual_bind_desc,
     _scene_pixel_visual_pipeline_desc, _scene_pixel_visual_shader_desc,
     _scene_pixel_visual_draw_desc, NULL, false, true},
    {DVZ_VISUAL_TYPE_MARKER, "marker", _scene_marker_visual_lowering,
     _scene_visual_default_bounds, _scene_visual_default_pass_caps,
     _scene_marker_visual_bind_desc, _scene_marker_visual_pipeline_desc,
     _scene_marker_visual_shader_desc, _scene_marker_visual_draw_desc, NULL, false, true},
    {DVZ_VISUAL_TYPE_SEGMENT, "segment", _scene_segment_visual_lowering,
     _scene_segment_visual_bounds, _scene_visual_default_pass_caps,
     _scene_segment_visual_bind_desc, _scene_segment_visual_pipeline_desc,
     _scene_segment_visual_shader_desc, _scene_segment_visual_draw_desc, NULL, false, false},
    {DVZ_VISUAL_TYPE_PATH, "path", _scene_path_visual_lowering, _scene_visual_default_bounds,
     _scene_visual_default_pass_caps, _scene_path_visual_bind_desc,
     _scene_path_visual_pipeline_desc, _scene_path_visual_shader_desc,
     _scene_path_visual_draw_desc, NULL, true, false},
    {DVZ_VISUAL_TYPE_IMAGE, "image", _scene_image_visual_lowering, _scene_image_visual_bounds,
     _scene_visual_default_pass_caps, _scene_image_visual_bind_desc,
     _scene_image_visual_pipeline_desc, _scene_image_visual_shader_desc,
     _scene_image_visual_draw_desc,
     _scene_image_visual_fill_metadata, false, false},
    {DVZ_VISUAL_TYPE_MESH, "mesh", _scene_mesh_visual_lowering, _scene_mesh_visual_bounds,
     _scene_visual_default_pass_caps, _scene_mesh_visual_bind_desc,
     _scene_mesh_visual_pipeline_desc, _scene_mesh_visual_shader_desc,
     _scene_mesh_visual_draw_desc, NULL, true, true},
    {DVZ_VISUAL_TYPE_VOLUME, "volume", _scene_volume_visual_lowering,
     _scene_volume_visual_bounds, _scene_visual_default_pass_caps,
     ...
     _scene_volume_visual_fill_metadata, false, false},
    {DVZ_VISUAL_TYPE_PRIMITIVE, "primitive", _scene_primitive_visual_lowering,
     ...
     _scene_primitive_visual_shader_desc, _scene_primitive_visual_draw_desc, NULL, true, true},
    {DVZ_VISUAL_TYPE_SPHERE, "sphere", _scene_sphere_visual_lowering,
     _scene_sphere_visual_bounds, _scene_visual_default_pass_caps,
     _scene_sphere_visual_bind_desc, _scene_sphere_visual_pipeline_desc,
     _scene_sphere_visual_shader_desc, _scene_sphere_visual_draw_desc, NULL, true, true},
    {DVZ_VISUAL_TYPE_GLYPH, "glyph", _scene_glyph_visual_lowering, _scene_glyph_visual_bounds,
     _scene_visual_default_pass_caps, _scene_glyph_visual_bind_desc,
     _scene_glyph_visual_pipeline_desc, _scene_glyph_visual_shader_desc,
     _scene_glyph_visual_draw_desc, NULL, true, false},
    {DVZ_VISUAL_TYPE_TEXT, "text", _scene_text_visual_lowering, _scene_visual_default_bounds,
     _scene_visual_default_pass_caps, _scene_text_visual_bind_desc,
     _scene_text_visual_pipeline_desc, _scene_text_visual_shader_desc,
     _scene_text_visual_draw_desc, NULL, false, false},
    {DVZ_VISUAL_TYPE_LABELS, "labels", _scene_labels_visual_lowering,
     ...
     _scene_labels_visual_shader_desc, _scene_labels_visual_draw_desc,
     _scene_labels_visual_fill_metadata, false, false},
    {DVZ_VISUAL_TYPE_SPLAT, "splat", _scene_splat_visual_lowering, _scene_visual_default_bounds,
     _scene_visual_default_pass_caps, _scene_splat_visual_bind_desc,
     _scene_splat_visual_pipeline_desc, _scene_splat_visual_shader_desc,
     _scene_splat_visual_draw_desc, NULL, false, false},
    {DVZ_VISUAL_TYPE_VECTOR, "vector", _scene_vector_visual_lowering,
     _scene_vector_visual_bounds, _scene_visual_default_pass_caps,
     _scene_vector_visual_bind_desc, _scene_vector_visual_pipeline_desc,
     _scene_vector_visual_shader_desc, _scene_vector_visual_draw_desc, NULL, false, false},
};
