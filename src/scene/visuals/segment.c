...
DvzVisual* dvz_segment(DvzRequester* rqr, int flags)
{
    ...
    // Vertex attributes.
    dvz_visual_attr(visual, 0, FIELD(DvzSegmentVertex, pos), DVZ_FORMAT_R32G32B32_SFLOAT, 0);
    dvz_visual_attr(visual, 1, FIELD(DvzSegmentVertex, color), DVZ_FORMAT_R8G8B8A8_UNORM, 0);
