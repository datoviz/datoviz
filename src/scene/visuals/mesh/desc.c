...
/*************************************************************************************************/
/*  Mesh visual descriptor lowering                                                              */
/*************************************************************************************************/
...
/**
 * Resolve mesh descriptor metadata.
 *
    ...
    const char** error)
{
    ...
    out->kind = _scene_visual_meta_desc_kind(&emitter->resources, meta);
    ...
    uint64_t texture_id = _scene_visual_desc_resource(emitter, meta->texture_id);
    if (texture_id != 0)
    {
        uint64_t texcoords_id = _scene_visual_desc_resource(emitter, meta->texcoords_id);
