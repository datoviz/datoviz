...
/*************************************************************************************************/
/*  Path visual pipeline descriptors                                                             */
/*************************************************************************************************/
...
/**
 * Resolve path-stroke pipeline metadata.
 *
 ...
 */
static void _path_stroke_pipeline_desc(
...
/**
 * Resolve indexed path pipeline metadata.
 *
 * @param visual the visual descriptor
 * @param caps resolved pass capabilities for the visual
 ...
 * @param out the output pipeline descriptor
 */
static void _path_primitive_pipeline_desc(
    const DvzSceneVisualDesc* visual, const DvzSceneVisualPassCaps* caps, bool picking,
    bool pass_needs_depth, bool wboit_accumulation, DvzAlphaMode alpha_mode,
...
/**
 * Resolve path visual pipeline metadata.
 *
 * @param visual the visual descriptor
 * @param picking whether the render pass is a picking pass
 * @param pass_needs_depth whether the containing render pass has a depth attachment
