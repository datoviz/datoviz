...
static uint64_t _scene_visual_public_id(const DvzScene* scene, const DvzVisual* visual);

static void _scene_panel_visual_order(const DvzPanel* panel, uint32_t* order);
