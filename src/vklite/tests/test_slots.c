...
int test_vklite_slots_1(TstSuite* suite, TstItem* tstitem)
{
    ...
    // Bindings.
    dvz_slots_binding(&slots, 0, 0, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER);
    dvz_slots_binding(&slots, 0, 1, VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE);
    dvz_slots_binding(&slots, 1, 0, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
