...
int test_video_1(TstSuite* suite, TstItem* tstitem)
{
    ...
    // dvz_images_usage(&nv12, VK_IMAGE_USAGE_STORAGE_BIT |
    // VK_IMAGE_USAGE_VIDEO_ENCODE_SRC_BIT_KHR);

    // // IMPORTANT: attach the video profile to pNext (Datoviz helper may expose this;
    // // otherwise you’ll need a raw VkImageCreateInfo patch — see note below)
