...
| `PARTICLES.md` | DRP2 compute/storage buffers exist below scene, point rendering exists, and `spec/scene/proposals/PARTICLE_SYSTEM_DESIGN.md` captures the proposed particle-system semantics. | Scene-level compute-written storage buffers consumed as vertex/instance input, persistent buffer reuse, additive/transparent particle shaders, optional trails accumulation framegraph, and per-frame parameter/UI controls. |
