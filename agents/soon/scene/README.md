...
4. [SCENE_SPHERE_RENDER_MODES_PLAN.md](SCENE_SPHERE_RENDER_MODES_PLAN.md): sphere render-mode
   follow-up.
5. [SCENE_SPHERE_VISUAL_PLAN.md](SCENE_SPHERE_VISUAL_PLAN.md): sphere visual implementation
   plan.
...
8. [SCENE_VOLUME_RENDERING_PLAN.md](SCENE_VOLUME_RENDERING_PLAN.md): volume visual implementation
   plan.
