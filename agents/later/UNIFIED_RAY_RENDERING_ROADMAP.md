...
1. `agents/now/SCENE_VOLUME_RENDERING_PLAN.md` for the near-term 3D volume implementation path,
2. `agents/now/SCREEN_SPACE_VOLUME_OCCLUSION_PLAN.md` for screen-space volume interaction ideas,
3. `agents/now/SCENE_NAPARI_IMAGE_LABELS_PLAN.md` for image/label colormap and palette semantics,
