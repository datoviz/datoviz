...
11. Use [HANDOFF_GPU_SELECTION.md](HANDOFF_GPU_SELECTION.md) for the approved native test-runner GPU selection direction, Windows hybrid-GPU evidence, implementation boundaries, report requirements, and physical validation matrix.
