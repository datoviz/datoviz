...
11. Use [HANDOFF_FRAME_DEMAND.md](HANDOFF_FRAME_DEMAND.md) for interaction pacing, refresh-aware FIFO latest-ready policy, the one-slot FIFO fallback, cross-platform evidence, and future motion extension.
12. Use [QA_SOURCE_AUDIT.md](QA_SOURCE_AUDIT.md) for the completed exploratory source-audit evidence integrated locally through final render/pacing head `545c99379`.
...
14. Use [RC3_RENDER_PRODUCTS_LANDING.md](RC3_RENDER_PRODUCTS_LANDING.md) and [RC3_RENDER_PRODUCTS_AFFECTED_QA.md](RC3_RENDER_PRODUCTS_AFFECTED_QA.md) for final render integration and affected QA. The R0-R9 handoff remains execution history, not current semantic authority.
