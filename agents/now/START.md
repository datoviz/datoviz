...
| Autonomous Linux code hardening | [Fractal campaign and subagent assignments](FRACTAL_CODE_HARDENING.md); planned focused failure-path QA, not a replay of completed audits |
