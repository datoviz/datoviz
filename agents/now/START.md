...
11. Use [HANDOFF_FRAME_DEMAND.md](HANDOFF_FRAME_DEMAND.md) for the implemented interaction pacing, one-slot FIFO default, cross-platform frame-slot evidence, and future motion extension.
