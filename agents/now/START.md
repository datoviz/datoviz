...
resolution, explicit untyped-visual compatibility naming, and sampled-field data setter split
commits through `472818e58`. `_scene.h` no longer exposes narrow helper declarations; its
remaining broadness is shared retained scene object and type definitions. Start with remaining
annotation/domain cleanup, residual query-family scratch/unsupported-policy ownership, the audited
explicit fixture/import compatibility path, and standalone candidate assessment in
[`../../spec/scene/implementation/SCENE_ARCHITECTURE_COMPLETION_PLAN.md`](../../spec/scene/implementation/SCENE_ARCHITECTURE_COMPLETION_PLAN.md);
