...
For the operational C implementation checklist, current next pickup item, and parallel work lanes,
see
[`V0_4_C_IMPLEMENTATION_CHECKLIST.md`](V0_4_C_IMPLEMENTATION_CHECKLIST.md).
