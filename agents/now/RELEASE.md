...
7. First-class vector visual polish, mesh face/region picking, path curve picking, volume DVR/MIP
...
7. The browser fixture dashboard passed fixture compatibility `120/120` and retained runtime
   stress `7/7`, including demo-session pan/zoom, resize, and stream-reload paths, on 2026-05-29
   after `a1c0d7306`.
8. The remaining RC1 decision is whether WASM scene emission is required before feature freeze or
