...
| Canonical source screenshots | review required | Eight of 104 reviewed PNGs are verified current. Ninety-six materially different isolated recaptures require visual review and exact approval before any `data` change. |
