...
Status: implemented distribution surface with RC3 exact base-artifact, conda, and vcpkg gates remaining; official Qt/PyQt provider artifacts are RC4. Local source, wheel, and vendor diagnostic evidence updated: 2026-09-08.
