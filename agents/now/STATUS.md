...
6. **Scene source split:** staged cleanup from
   ...
   standard query item decoding, and standard item-target eligibility are complete through
   2026-05-29.
