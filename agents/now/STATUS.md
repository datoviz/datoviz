...
| Label annotations and readouts | `Readout card and private rich block prototypes landed` | annotation/text realization tests, `test_app_offscreen_text_block_raster_has_nonblank_pixels`, `examples/c/techniques/image_probe.c`, [`PINNED_READOUT_OVERLAY_CARD_PLAN.md`](PINNED_READOUT_OVERLAY_CARD_PLAN.md) | Add second internal card consumer before public overlay API promotion; keep richer text-block polish as follow-up. |
