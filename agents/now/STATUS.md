...
2. Finish the hosted macOS wheel proof: `macos-13` x86_64 remains queued, and macOS arm64 still
   needs a release-target `macosx_11_0_arm64` artifact rather than a host `macosx_15_0_arm64` tag.
