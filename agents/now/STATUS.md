...
Status: active post-RC2 work toward RC3, then RC4 and final v0.4.0. Local QA, course preparation, and embedding-portability state updated: 2026-09-17. Published release and artifact state retain their earlier evidence; RC3 is not frozen.
...
RC3 implementation is integrated. The automated course review and [candidate preparation](RELEASE.md#rc3-preparation-before-maintainer-review-2026-09-08) are complete; maintainer review, PR disposition, candidate freeze, and exact artifact/platform proof remain. Completed local validation is not release approval. Use the lane records below rather than replaying completed campaigns.
