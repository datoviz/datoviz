...
| Documentation and gallery freeze | Public RC2 documentation is deployed, the three-chapter Vulkan pilot includes approved canonical previews in `data`, generated C reference covers all 1,578 exported functions across 13 pages, and Python guidance inventories all 18 adapted calls plus three generated helpers. Isolated verification proves eight source screenshots current; 96 materially different recaptures require visual review and exact approval before any `data` update. Attribution, provenance, visual-pilot review, and final RC3 inventory remain. | Review the 96 screenshot differences without touching `data`, review the visual pilot and tutorial voice, then freeze the non-tutorial RC3 surface; reserve full-course chapters and asset freeze for RC4. |
