...
| --- | --- | --- |
| Branch cutover | Executed: v0.4 is the protected default `main`, v0.3 is protected at `v0.3-maintenance`, both PR bases moved to `main`, and `dev` remains unchanged. | Complete reconciliation CI and fresh-clone verification, then close the cutover record. |
