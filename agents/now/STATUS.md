...
6. **Scene source split:** staged cleanup from
   ...
   decode ownership, field dirty propagation, and scalar field sampling are complete through
   2026-05-29.
