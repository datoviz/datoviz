...
7. [now/SCENE_VECTOR_VISUALS_PLAN.md](/home/cyrille/GIT/Viz/datoviz/agents/now/SCENE_VECTOR_VISUALS_PLAN.md)
8. [now/V0_4_RELEASE_READINESS_PLAN.md](/home/cyrille/GIT/Viz/datoviz/agents/now/V0_4_RELEASE_READINESS_PLAN.md)
...
new scene API growth, WebGPU runtime work, hygiene/static-analysis sweeps, and release-readiness
work as separate prioritized lanes rather than mixing them into one implementation pass.
...
2. Read [now/V0_4_RELEASE_READINESS_PLAN.md](/home/cyrille/GIT/Viz/datoviz/agents/now/V0_4_RELEASE_READINESS_PLAN.md)
   when working on post-feature-completion quality, API review, documentation, bindings, gallery,
   packaging, release candidates, or communication planning.
3. Read [../spec/scene/README.md](/home/cyrille/GIT/Viz/datoviz/spec/scene/README.md) before
...
4. Read [../spec/scene/api/API_SURFACE.md](/home/cyrille/GIT/Viz/datoviz/spec/scene/api/API_SURFACE.md)
   before changing public scene API shape or adding new scene object families.
5. Read [now/SCENE_PUBLIC_API_HEADER_PLAN.md](/home/cyrille/GIT/Viz/datoviz/agents/now/SCENE_PUBLIC_API_HEADER_PLAN.md)
   to distinguish implemented public scene APIs from drafted-but-not-yet-implemented APIs.
6. Read [now/DRP2_SPEC.md](/home/cyrille/GIT/Viz/datoviz/agents/now/DRP2_SPEC.md) if touching
   `spec/drp2/`, `src/drp2/`, or DRP2-emitting scene code.
7. Read [done/SCENE_DRP2_IMPLEMENTATION.md](/home/cyrille/GIT/Viz/datoviz/agents/done/SCENE_DRP2_IMPLEMENTATION.md)
...
9. Read [now/SCENE_WGSL_SHADER_VARIANTS_PLAN.md](/home/cyrille/GIT/Viz/datoviz/agents/now/SCENE_WGSL_SHADER_VARIANTS_PLAN.md)
   before moving scene-owned built-in shaders toward WebGPU/WGSL emission.
10. Read [now/WBOIT_MESH_INTERACTIVE_PLAN.md](/home/cyrille/GIT/Viz/datoviz/agents/now/WBOIT_MESH_INTERACTIVE_PLAN.md)
   before working on WBOIT, transparent meshes, scene alpha modes, multi-attachment render passes,
   or transparent mesh examples.
11. Read [now/SCENE_TECHNIQUES_MATERIALS_PLAN.md](/home/cyrille/GIT/Viz/datoviz/agents/now/SCENE_TECHNIQUES_MATERIALS_PLAN.md)
    before adding depth cueing, EDL, SSAO, outlines, materials, or visual pass capabilities.
12. Read [now/SCENE_VECTOR_VISUALS_PLAN.md](/home/cyrille/GIT/Viz/datoviz/agents/now/SCENE_VECTOR_VISUALS_PLAN.md)
    before adding segment, stroked path, dashed line, arrow/vector, tube, or SVG-subset visuals.
